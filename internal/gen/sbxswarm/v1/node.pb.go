...
type NodeSummary struct {
	...
	Kits          []string               `protobuf:"bytes,18,rep,name=kits,proto3" json:"kits,omitempty"`                                        // kit names this node advertises
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NodeSummary) GetKits() []string {
	if x != nil {
		return x.Kits
	}
	return nil
...
const file_sbxswarm_v1_node_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\tR\tcreatedAt\"\x95\x05\n" +
	...
	"\x0egit_workspaces\x18\x11 \x03(\tR\rgitWorkspaces\x12\x12\n" +
