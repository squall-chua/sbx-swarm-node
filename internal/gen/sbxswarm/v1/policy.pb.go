...
func (x *DeletePolicyRuleRequest) GetScope() string {
	if x != nil {
		return x.Scope
	}
	return ""
...
func (x *DeletePolicyRuleRequest) GetResource() string {
	if x != nil {
		return x.Resource
	}
	return ""
...
// the real secret behind the proxy changes. An entry created outside the node
// (directly with `sbx`, or by a kit) may cover several hosts; a replace through
// this RPC collapses it down to the single host given here.
//
